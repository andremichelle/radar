...
export class Renderer {
    static renderRadarInside(context, angleResolution, distanceResolution) {
    ...
    static renderRayOrigin(context, origin) {
    ...
    static renderCursor(context, local) {
    ...
    static renderObstacles(context, pattern, selection) {
    ...
    static renderRayTrail(context, pattern, ray) {
        context.lineWidth = 0.0;
        ...
        const iterator = ray.trace(pattern.getObstacles());
    ...
    static renderWaveformPosition(context, angle, width, lineWidth = 1.0) {
    ...
    static renderWaveform(buffer, size, width) {
